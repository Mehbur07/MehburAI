...
- 📞 **JARVIS Görüşmesi:** Sohbet kutusundaki telefon butonuna basınca tam ekran JARVIS açılır ve eller serbest sesli görüşme başlar: "Emrinizdeyim efendim" der, sen konuşursun, cevabı seslendirir, tekrar dinler ('Hey Mehbur' demek gerekmez). Bitirmek için "görüşmeyi bitir" / "görüşürüz" de, 📞'ye tekrar bas, ESC'ye bas ya da ekrana tıkla; 3 tur art arda konuşulmazsa kendiliğinden kapanır. 🎤 butonu eskisi gibi sesli mesaj (bas-konuş) içindir.
